...
public class AppDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Rule>().ToTable("Rules", "security");
        builder.Entity<UserPermission>().ToTable("UserPermissions", "security");
        builder.Entity<ApprovalWorkflow>().ToTable("ApprovalWorkflows", "dbo");
        builder.Entity<ApprovalStep>().ToTable("ApprovalSteps", "dbo");
        builder.Entity<ApprovalTransaction>().ToTable("ApprovalTransactions", "dbo");
        ...
        builder.Entity<RolePermission>().HasQueryFilter(rp => !rp.IsDeleted);
        builder.Entity<Rule>().HasQueryFilter(r => !r.IsDeleted);
        builder.Entity<ApprovalWorkflow>().HasQueryFilter(w => !w.IsDeleted);
        builder.Entity<ApprovalStep>().HasQueryFilter(s => !s.IsDeleted);
        builder.Entity<ApprovalTransaction>().HasQueryFilter(t => !t.IsDeleted);
