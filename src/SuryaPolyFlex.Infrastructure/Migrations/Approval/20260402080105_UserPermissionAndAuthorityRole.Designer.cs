...
namespace SuryaPolyFlex.Infrastructure.Migrations.Approval
{
    ...
    [Migration("20260402080105_UserPermissionAndAuthorityRole")]
    partial class UserPermissionAndAuthorityRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SuryaPolyFlex.Domain.Entities.Core.ApprovalStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApprovalSteps", "dbo");
                });

            modelBuilder.Entity("SuryaPolyFlex.Domain.Entities.Core.ApprovalTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApprovalTransactions", "dbo");
                });
            ...
            modelBuilder.Entity("SuryaPolyFlex.Domain.Entities.Core.ApprovalWorkflow", b =>
                {
                    ...
                    b.ToTable("ApprovalWorkflows", "dbo");
                });
            ...
            modelBuilder.Entity("SuryaPolyFlex.Domain.Entities.Core.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SuryaPolyFlex.Domain.Entities.Core.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SuryaPolyFlex.Domain.Entities.Core.Rule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SuryaPolyFlex.Domain.Entities.Core.ApprovalStep", b =>
                {
                    b.HasOne("SuryaPolyFlex.Domain.Entities.Core.ApprovalWorkflow", "Workflow")
                        .WithMany("Steps")
